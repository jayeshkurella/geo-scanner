    ...
    def validate_forgot_password(self, request, username, authentication_code):
        ...
        try:
            ...
            if current_user.forgot_password_is_active is False:
                ...
                if datetime.datetime.now() - current_user.forgot_pass_time > datetime.timedelta(days=1):
                    ...
                    if not current_user.forgot_pass_code == authentication_code:
                        ...
                        return HttpResponseRedirect(f'https://products.coderize.in/dev/fruitly/forgotpassword?reset_password_link={data["reset_password_link"]}')
    ...
    def reset_password(self, request, username, secret_key):
        ...
        try:
            ...
            if new_password:
                ...
                elif datetime.datetime.now() - current_user.forgot_password_reset_secret_time > datetime.timedelta(
                        minutes=5):
